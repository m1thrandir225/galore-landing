    ...
    return (
        <div className={"w-full bg-main h-[500px] grid grid-cols-2 grid-rows-1 p-4 rounded-[24px] overflow-hidden my-[80px]"}>
            <div
                ...
                >
                    Elevate your cocktail experience with Galore!
                    Powered by a smart recommendation algorithm, effortlessly find your next favorite drink.
                    Save your go-to recipes, and unleash your creativity with
                    AI-driven cocktail generation tailored just for you.
                </motion.p>
                <motion.button
                    className={"text-onMainContainer font-satoshi font-bold py-4 px-8 rounded-[16px] bg-mainContainer hover:opacity-75 transition-opacity ease-in-out duration-100"}
                    initial={{
                        opacity: 0,
                        y: -100
                    }}
